...
The same heartbeat also carries each agent's current target parcel and planned next
step. By broadcasting this information continuously, both agents can see in advance
when they are converging on the same parcel or tile and react, one yielding or
re-deliberating toward a different target, without any explicit negotiation or
locking protocol.
