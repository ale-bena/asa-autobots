\chapter{Tests}
\label{ch:tests}
Both agents have been tested locally during the building process continuously,
to find bugs, test different configurations, and improve them. 

Extra attention was dedicated to checking the structure of the messages and actions proposed by the LLM,
...
We have found creating an appropriate, logically sound system prompt for the LLM not trivial, 
as it frequently tried to veer off the guardrails.

Some known limitations we found were: the occasional inability of the LLM to reason about associating 
