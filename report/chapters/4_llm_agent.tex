...
executor (\ref{ch:bdi}), so it too can move, pick up, deliver, and clear crates
with PDDL (\ref{ch:pddl}). What sets it apart is an additional natural-language
