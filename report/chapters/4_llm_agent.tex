...
There were 3 possibl model to chose from and the one selected is llama-3.3-70b-lmstudio.
...
model under a fixed system prompt. The model returns one \underline{strictly} validated JSON
...
answers returned in that same order(\underline{limitation section}).
