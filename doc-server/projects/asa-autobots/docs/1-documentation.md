...
<li><strong>Reward Filters</strong>: If a rule states <code>maxRewardLimit = 10</code>, parcels with rewards > 10 are flagged as inactive in beliefs, removing them from candidate desires.</li>
</ul>
